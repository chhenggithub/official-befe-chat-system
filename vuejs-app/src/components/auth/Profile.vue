                      ...
                      >
                        ...
                        <div class="col-sm-9">
                          <input
                            ...
                            :class="
                              !!userError.current_password ? 'is-invalid' : ''
                            "
                          />
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input
                            ...
                            :class="
                              !!userError.new_password ? 'is-invalid' : ''
                            "
                          />
                          <div class="invalid-feedback">
...
function onResetImage() {
  selectedImageFile.value = null;
  tempImage.value = userStore.profile_image
...
async function saveProfileImage() {
  try {
    ...
    userStore.profile_thumbnail = isDeleting
      ? null
      : response.data.profile_thumbnail;
    selectedImageFile.value = null;
    await MessageModal({
      icon: "success",
      title: "Success",
