            ...
            <div class="col-auto">
              <div class="input-group input-group">
                ...
                <select v-model="pageSize" class="form-control">
                  <option
                    v-for="size in [10, 25, 50, 100, 250]"
                    :key="size"
                    :value="size"
                  >
                    {{ size }}
          ...
          <div class="d-flex justify-content-center">
            <div class="dataTables_paginate paging_simple_numbers">
              <ul class="pagination">
                ...
                <!-- Ellipsis after -->
                <li
                  v-if="currentPage < lastPage - sidePage"
                  class="paginate_button page-item"
                >
                  <a class="page-link" style="cursor: default">...</a>
                </li>
                ...
                >
                  <a
                    @click.prevent="
                      currentPage < lastPage && changePage(lastPage)
                    "
                    role="button"
                    tabindex="0"
                    class="page-link"
