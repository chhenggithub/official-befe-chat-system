                ...
                >
                  <div class="direct-chat-infos clearfix">
                    <span
                      ...
                      :class="
                        isOwnMessage(message) ? 'float-right' : 'float-left'
                      "
            ...
            <form @submit.prevent="sendMessage">
              <div class="input-group">
                <template v-if="isRecording">
                  <span
                    class="form-control d-flex align-items-center text-danger"
                  >
                ...
                <template v-else-if="selectedImageFile">
                  <span class="form-control d-flex align-items-center">
                    <i class="fas fa-image mr-2 text-secondary"></i>
...
async function saveEdit(messageId) {
  ...
  try {
    const response = await apiUpdateChatMessage(
      props.chatId,
      messageId,
      editContent.value,
    );
...
async function sendMessage() {
  ...
  try {
    const response = await apiCreateChatMessage(
      props.chatId,
